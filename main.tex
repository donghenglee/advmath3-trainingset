...
%简体字版本latex code的code snippet,注意一定要简体字,以\question开始然后才\begin{solution},尽量按照原文,用\[\]或\begin{align*}或$...$但不要用$$...$$,一行\[然后content然后一行\],用\frac不要a/b,结果不要使用 [...],中文字不可以在\[\]里面,不要用\text{中文字},把\over换成\frac{}{},不要用\textbf{} ,\boxed及\ans,去掉\overline{},句号不要在\[...\]
...
\begin{center}
    {\Large 数论}
\end{center}
\hyperlink{整除}{整除} \dotfill \pageref{整除} \\
\hyperlink{同余}{同余} \dotfill \pageref{同余} \\
