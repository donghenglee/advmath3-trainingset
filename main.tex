...
%简体字版本latex code的code snippet,注意一定要简体字,以\question开始然后才\begin{solution},尽量按照原文,用\[\]或\begin{align*}或$...$但不要用$$...$$,一行\[然后content然后一行\],用\frac{}{}不要a/b,结果不要使用 [...],中文字不可以在\[\]里面,不要用\text{中文字},把\over换成\frac{}{},不要用\textbf{} ,\boxed及\ans,去掉\overline{},句号不要在\[...\],dx之前要\,
...
\qquad 为此，我广泛参考了美、加两国的数学竞赛，以及日、印两国的大学入学考，甚至涵盖了台湾的教师甄选题，等等。尽管整理过程艰辛，但也领略了全球不同地区的数学教纲，宛如经历了一场“数学环游世界”。\\[10pt]
...
\hyperlink{计数、排列、组合}{计数、排列、组合} \dotfill \pageref{计数、排列、组合} \\
