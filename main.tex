...
%简体字版本latex code,注意一定要简体字,以\question开始然后才\begin{solution},尽量按照原文,用\[\]或\begin{align*}或$...$但不要用$$...$$,中文字不可以在\[\]里面,不要用\text{中文字},把\over换成\frac{}{},不要用\textbf{} ,\boxed及\ans,去掉\overline{},句号不要在\[...\]
...
%linear algebra线代启示录
%陈景润,华罗庚,APMO,SEAMO,CTMC,CSMC,AMC,台湾,中国
...
\hyperlink{根式}{根式} \dotfill \pageref{根式} \\
\hyperlink{取整函数}{取整函数} \dotfill \pageref{取整函数} \\
...
\hyperlink{行列式、矩阵}{行列式、矩阵} \dotfill \pageref{行列式、矩阵} \\
...
\hyperlink{轨迹方程式、参数方程式、极坐标}{轨迹方程式、参数方程式、极坐标} \dotfill \pageref{轨迹方程式、参数方程式、极坐标} \\
...
\begin{itemize}
    ...
    \item \href{https://www.facebook.com/fulun.tan.58}{福伦的数学笔记}
\end{itemize}
\end{multicols}
总题数: \numquestions{}
\end{document}
